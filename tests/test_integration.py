...
def test_run_poppunk(client, qtbot):
    ...
    assert project_data["samples"]["c448c13f7efd6a5e7e520a7495f3f40f"]["sketch"] == sketches["7622_5_91"]
    assert project_data["samples"]["c448c13f7efd6a5e7e520a7495f3f40f"]["cluster"] == 'GPSC3'
    assert project_data["samples"]["b92f525d6e54194a06fd250e5d64b08e"]["sketch"] == sketches["6930_8_9"]
    assert project_data["samples"]["b92f525d6e54194a06fd250e5d64b08e"]["cluster"] == 'GPSC60'
