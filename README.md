...
The smaller (refs) database has been generated by us from the full database, using the `poppunk_references` script
in [PopPUNK](https://github.com/bacpop/PopPUNK/), and is stored on mrcdata. This process will probably need to be 
repeated for future versions of the database. The full database is downloaded from Sanger. 
